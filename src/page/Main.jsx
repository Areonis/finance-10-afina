...
import logo2 from '../assets/pic4.png'
import logo3 from '../assets/pic3.png'
import logo4 from '../assets/pic2.png'
import logo5 from '../assets/pic1.png'
      ...
      <div className={styles.under_header}>
        <div className={styles.under_header__item}>
          <div className={styles.under_header__title}>
            Предоставьте финансовое планирование нашему сервису!
          </div>
      ...
      <ContentBlock bg="sky_blue" direction="row" gap={0} gridColumn="1/7">
        ...
        <TextBlock direction="column">
          <Title size="40px" position="right">
            {' '}
            Лучшие практики бизнеса для вас
          </Title>
        </TextBlock>
      </ContentBlock>
